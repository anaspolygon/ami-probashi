...
const JobTraining = ({ imageUrl, job }: Props) => {
  const t = useTranslations("migrantWorkers.tabs.tabThree");
    ...
    <div className="px-4 md:px-0 flex flex-col md:flex-row justify-between md:gap-16 mt-[4%] md:mt-8">
      <div className="flex-1 order-2 md:order-1">
        <div
          dangerouslySetInnerHTML={{
            __html: isBn
              ? job && job.migrate_tab_desc_bn
              : job && job.migrate_tab_desc_en,
          }}
          className="worker"
        ></div>
        {/* <div className="mb-4 md:mb-6">
          ...
          <p className="roboto font-normal text-sm md:text-lg leading-5 md:leading-7 text-[#475569] ">
            ...
            <Link
              ...
              href={migrantWorkers.jobTraining.verifyJob}
            >
              {m("learnmore")}
            </Link>
          </p>
        ...
        <div className="mb-4 md:mb-6">
          ...
          <p className="roboto font-normal text-sm md:text-lg leading-5 md:leading-7 text-[#475569] ">
            ...
            <Link
              className="text-[#187E7D] text-sm md:text-lg font-semibold underline underline-offset-4"
              href={migrantWorkers.jobTraining.authenticEmployer}
            >
              {m("learnmore")}
            </Link>
          </p>
        ...
        <div className="mb-4 md:mb-6">
          ...
          <p className="roboto font-normal text-sm md:text-lg leading-5 md:leading-7 text-[#475569] ">
            ...
            <Link
              className="text-[#187E7D] text-sm md:text-lg font-semibold underline underline-offset-4"
              href={migrantWorkers.jobTraining.cvBuilder}
            >
              {m("learnmore")}
            </Link>
          </p>
        ...
        <div className="mb-4 md:mb-6">
          ...
          <p className="roboto font-normal text-sm md:text-lg leading-5 md:leading-7 text-[#475569] ">
            ...
            <Link
              className="text-[#187E7D] text-sm md:text-lg font-semibold underline underline-offset-4"
              href={migrantWorkers.jobTraining.skillDevelopment}
            >
              {" "}
              {m("learnmore")}
            </Link>
      ...
      >
        <Image
          ...
          // src="/assets/images/workers/job_training.webp"
          src={imageUrl && getImageUrl(imageUrl, (job && job?.image) ?? "")}
          width={433}
          height={487}
          alt=""
        />
