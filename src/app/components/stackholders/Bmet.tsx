...
const Bmet = ({ imageUrl, bmet }: Props) => {
  const t = useTranslations("governmentStackholders.tabs.tabOne");
    ...
    <div className="px-4 md:px-0 flex flex-col md:flex-row mt-[4%] md:mt-8">
      <div
        ...
        dangerouslySetInnerHTML={{
          __html: isBn ? bmet?.govt_tab_desc_bn : bmet?.govt_tab_desc_en,
        }}
      >
      ...
      >
        <Image
          ...
          // src="/assets/images/stackholders/bmet_service_1.webp"
          // src="/assets/images/stackholders/images_1.webp"
          src={bmet && getImageUrl(imageUrl, bmet.image ?? "")}
          width={493}
          height={470}
          alt=""
        />
